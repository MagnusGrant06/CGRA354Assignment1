...
Run the `cmake` command (from within the build directory) for Visual Studio with the appropriate version number (XX).
```sh
...
See a full list here for later versions of Visual Studio: https://cmake.org/cmake/help/latest/manual/cmake-generators.7.html#visual-studio-generators
